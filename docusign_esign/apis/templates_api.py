...
class TemplatesApi(object):
    ...
    def list_templates_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'count', 'folder', 'folder_ids', 'folder_types', 'from_date', 'include', 'order', 'order_by', 'search_text', 'shared', 'shared_by_me', 'start_position', 'to_date', 'used_from_date', 'used_to_date', 'user_filter', 'user_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_documents_with_http_info(self, account_id, template_id, **kwargs):
        ...
        all_params = ['account_id', 'template_id', 'apply_document_fields', 'envelope_definition']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
