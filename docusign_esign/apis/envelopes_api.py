...
class EnvelopesApi(object):
    ...
    def get_envelope_doc_gen_form_fields(self, account_id, envelope_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_envelope_doc_gen_form_fields_with_http_info(account_id, envelope_id, **kwargs)
        else:
            (data) = self.get_envelope_doc_gen_form_fields_with_http_info(account_id, envelope_id, **kwargs)
            return data
    ...
    def get_envelope_doc_gen_form_fields_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_envelope_doc_gen_form_fields" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_envelope_doc_gen_form_fields`")
        # verify the required parameter 'envelope_id' is set
        if ('envelope_id' not in params) or (params['envelope_id'] is None):
            raise ValueError("Missing the required parameter `envelope_id` when calling `get_envelope_doc_gen_form_fields`")


        collection_formats = {}

        resource_path = '/v2.1/accounts/{accountId}/envelopes/{envelopeId}/docGenFormFields'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'envelope_id' in params:
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='DocGenFormFieldResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def list_documents_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        all_params = ['account_id', 'envelope_id', 'documents_by_userid', 'include_docgen_formfields', 'include_document_size', 'include_metadata', 'include_tabs', 'recipient_id', 'shared_user_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'documents_by_userid' in params:
            query_params['documents_by_userid'] = params['documents_by_userid']
        if 'include_docgen_formfields' in params:
    ...
    def list_status_changes_with_http_info(self, account_id, **kwargs):
        ...
        if 'search_mode' in params:
            query_params['search_mode'] = params['search_mode']
    ...
    def update_document(self, account_id, document_id, envelope_id, document_file_bytes, **kwargs):
        ...
        :param str document_id: The ID of the document being accessed. (required)
        :param str envelope_id: The envelopeId Guid of the envelope being accessed. (required)
        :param str document_file_bytes: Updated document content. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_document_with_http_info(account_id, document_id, envelope_id, document_file_bytes, **kwargs)
        else:
            (data) = self.update_document_with_http_info(account_id, document_id, envelope_id, document_file_bytes, **kwargs)
            return data
    ...
    def update_document_with_http_info(self, account_id, document_id, envelope_id, document_file_bytes, **kwargs):
        ...
        all_params = ['account_id', 'document_id', 'envelope_id', 'document_file_bytes']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('document_file_bytes' not in params) or (params['document_file_bytes'] is None):
            raise ValueError("Missing the required parameter `document_file_bytes` when calling `update_document`")
        ...
        body_params = None
        if 'document_file_bytes' in params:
            body_params = params['document_file_bytes']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
        ...
        header_params['Content-Type'] = self.api_client.\
            select_header_content_type(['application/pdf'])
    ...
    def update_envelope_doc_gen_form_fields(self, account_id, envelope_id, **kwargs):
        ...
        :param str account_id: The external account number (int) or account ID Guid. (required)
        :param str envelope_id: The envelopeId Guid of the envelope being accessed. (required)
        :param str update_docgen_formfields_only:
        :param DocGenFormFieldRequest doc_gen_form_field_request:
        :return: DocGenFormFieldResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_envelope_doc_gen_form_fields_with_http_info(account_id, envelope_id, **kwargs)
        else:
            (data) = self.update_envelope_doc_gen_form_fields_with_http_info(account_id, envelope_id, **kwargs)
            return data
    ...
    def update_envelope_doc_gen_form_fields_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        all_params = ['account_id', 'envelope_id', 'update_docgen_formfields_only', 'doc_gen_form_field_request']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_envelope_doc_gen_form_fields" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `update_envelope_doc_gen_form_fields`")
        # verify the required parameter 'envelope_id' is set
        if ('envelope_id' not in params) or (params['envelope_id'] is None):
            raise ValueError("Missing the required parameter `envelope_id` when calling `update_envelope_doc_gen_form_fields`")
        ...
        query_params = {}
        if 'update_docgen_formfields_only' in params:
            query_params['update_docgen_formfields_only'] = params['update_docgen_formfields_only']
        ...
        body_params = None
        if 'doc_gen_form_field_request' in params:
            body_params = params['doc_gen_form_field_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
