...
class EnvelopesApi(object):
    ...
    def create_envelope_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'cdse_mode', 'completed_documents_only', 'merge_roles_on_draft', 'envelope_definition']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def create_view_link(self, account_id, envelope_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_view_link(account_id, envelope_id, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str account_id: The external account number (int) or account ID Guid. (required)
        :param str envelope_id: The envelopeId Guid of the envelope being accessed. (required)
        :param ViewLinkRequest view_link_request:
        :return: ViewUrl
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_view_link_with_http_info(account_id, envelope_id, **kwargs)
        else:
            (data) = self.create_view_link_with_http_info(account_id, envelope_id, **kwargs)
            return data

    def create_view_link_with_http_info(self, account_id, envelope_id, **kwargs):
        """
        Reserved: Returns a URL to the secure link view UI.
        Reserved: Returns a URL that allows you to embed the secure link view of the DocuSign UI in your applications.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_view_link_with_http_info(account_id, envelope_id, callback=callback_function)
        ...
        all_params = ['account_id', 'envelope_id', 'view_link_request']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_view_link" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `create_view_link`")
        # verify the required parameter 'envelope_id' is set
        if ('envelope_id' not in params) or (params['envelope_id'] is None):
            raise ValueError("Missing the required parameter `envelope_id` when calling `create_view_link`")


        collection_formats = {}

        resource_path = '/v2/accounts/{accountId}/envelopes/{envelopeId}/views/viewlink'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'envelope_id' in params:
        ...
        body_params = None
        if 'view_link_request' in params:
            body_params = params['view_link_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
    ...
    def delete_view_link(self, account_id, envelope_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_view_link(account_id, envelope_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_view_link_with_http_info(account_id, envelope_id, **kwargs)
        else:
            (data) = self.delete_view_link_with_http_info(account_id, envelope_id, **kwargs)
            return data

    def delete_view_link_with_http_info(self, account_id, envelope_id, **kwargs):
        """
        Reserved: Expires a secure view link.
        Reserved: Expires a secure view link
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_view_link_with_http_info(account_id, envelope_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_view_link" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `delete_view_link`")
        # verify the required parameter 'envelope_id' is set
        if ('envelope_id' not in params) or (params['envelope_id'] is None):
            raise ValueError("Missing the required parameter `envelope_id` when calling `delete_view_link`")
    ...
    def list_documents_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        all_params = ['account_id', 'envelope_id', 'include_metadata']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_status_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'email', 'from_date', 'start_position', 'to_date', 'envelope_ids_request']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_documents_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        all_params = ['account_id', 'envelope_id', 'apply_document_fields', 'envelope_definition']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
