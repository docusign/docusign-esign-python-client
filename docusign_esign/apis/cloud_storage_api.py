...
class CloudStorageApi(object):
    ...
    def create_provider_with_http_info(self, account_id, user_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/users/{userId}/cloud_storage'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_provider_with_http_info(self, account_id, service_id, user_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/users/{userId}/cloud_storage/{serviceId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def get_provider(self, account_id, service_id, user_id, **kwargs):
        ...
        :param str service_id: The ID of the service to access.   Valid values are the service name (\"Box\") or the numerical serviceId (\"4136\"). (required)
        :param str user_id: The user ID of the user being accessed. Generally this is the user ID of the authenticated user, but if the authenticated user is an Admin on the account, this may be another user the Admin user is accessing. (required)
        :param str redirect_url:  The URL the user is redirected to after the cloud storage provider authenticates the user. Using this will append the redirectUrl to the authenticationUrl.  The redirectUrl is restricted to URLs in the docusign_esign.com or docusign_esign.net domains.
        :return: CloudStorageProviders
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_with_http_info(self, account_id, folder_id, service_id, user_id, **kwargs):
        ...
        all_params = ['account_id', 'folder_id', 'service_id', 'user_id', 'cloud_storage_folder_path', 'count', 'order', 'order_by', 'search_text', 'start_position']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        resource_path = '/v2/accounts/{accountId}/users/{userId}/cloud_storage/{serviceId}/folders/{folderId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def list_folders_with_http_info(self, account_id, service_id, user_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/users/{userId}/cloud_storage/{serviceId}/folders'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'service_id' in params:
