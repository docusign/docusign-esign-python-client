...
class ConnectApi(object):
    ...
    def create_connect_o_auth_config(self, account_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_connect_o_auth_config_with_http_info(account_id, **kwargs)
        else:
            (data) = self.create_connect_o_auth_config_with_http_info(account_id, **kwargs)
            return data
    ...
    def create_connect_o_auth_config_with_http_info(self, account_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_connect_o_auth_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `create_connect_o_auth_config`")
    ...
    def delete_connect_o_auth_config(self, account_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_connect_o_auth_config_with_http_info(account_id, **kwargs)
        else:
            (data) = self.delete_connect_o_auth_config_with_http_info(account_id, **kwargs)
            return data
    ...
    def delete_connect_o_auth_config_with_http_info(self, account_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_connect_o_auth_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `delete_connect_o_auth_config`")
    ...
    def get_connect_o_auth_config(self, account_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_connect_o_auth_config_with_http_info(account_id, **kwargs)
        else:
            (data) = self.get_connect_o_auth_config_with_http_info(account_id, **kwargs)
            return data
    ...
    def get_connect_o_auth_config_with_http_info(self, account_id, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_connect_o_auth_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_connect_o_auth_config`")
