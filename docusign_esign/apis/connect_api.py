...
class ConnectApi(object):
    ...
    def create_configuration_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_connect_secret_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/secret'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def delete_configuration_with_http_info(self, account_id, connect_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/{connectId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def delete_connect_secret_with_http_info(self, account_id, key_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/secret/{keyId}/delete'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'key_id' in params:
    ...
    def delete_event_failure_log_with_http_info(self, account_id, failure_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/failures/{failureId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def delete_event_log_with_http_info(self, account_id, log_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/logs/{logId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'log_id' in params:
    ...
    def delete_event_logs_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/logs'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def delete_mobile_notifiers_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/mobile_notifiers'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def generate_connect_secret(self, account_id, **kwargs):
        """
        Generates a new connect HMAC Secret.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_connect_secret(account_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.generate_connect_secret_with_http_info(account_id, **kwargs)
        else:
            (data) = self.generate_connect_secret_with_http_info(account_id, **kwargs)
            return data

    def generate_connect_secret_with_http_info(self, account_id, **kwargs):
        """
        Generates a new connect HMAC Secret.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_connect_secret_with_http_info(account_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method generate_connect_secret" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `generate_connect_secret`")
    ...
    def get_connect_secrets(self, account_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_connect_secrets(account_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_connect_secrets_with_http_info(account_id, **kwargs)
        else:
            (data) = self.get_connect_secrets_with_http_info(account_id, **kwargs)
            return data

    def get_connect_secrets_with_http_info(self, account_id, **kwargs):
        """
        Get the connect HMAC Secrets for AccountID
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_connect_secrets_with_http_info(account_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_connect_secrets" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `get_connect_secrets`")


        collection_formats = {}

        resource_path = '/v2/accounts/{accountId}/connect/secrets'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def list_event_failure_logs_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/failures'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def list_tests(self, account_id, connect_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_tests(account_id, connect_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_tests_with_http_info(account_id, connect_id, **kwargs)
        else:
            (data) = self.list_tests_with_http_info(account_id, connect_id, **kwargs)
            return data

    def list_tests_with_http_info(self, account_id, connect_id, **kwargs):
        """
        Test connect configuration.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_tests_with_http_info(account_id, connect_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_tests" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `list_tests`")
        # verify the required parameter 'connect_id' is set
        if ('connect_id' not in params) or (params['connect_id'] is None):
            raise ValueError("Missing the required parameter `connect_id` when calling `list_tests`")


        collection_formats = {}

        resource_path = '/v2/accounts/{accountId}/connect/{connectId}/tests'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'connect_id' in params:
    ...
    def list_users_with_http_info(self, account_id, connect_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/{connectId}/users'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
        if 'connect_id' in params:
    ...
    def retry_event_for_envelope_with_http_info(self, account_id, envelope_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/envelopes/{envelopeId}/retry_queue'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def retry_event_for_envelopes_with_http_info(self, account_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/connect/envelopes/retry_queue'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
