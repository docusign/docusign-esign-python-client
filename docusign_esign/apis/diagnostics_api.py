...
class DiagnosticsApi(object):
    ...
    def delete_request_logs_with_http_info(self, **kwargs):
        ...
        resource_path = '/v2/diagnostics/request_logs'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_request_log_with_http_info(self, request_log_id, **kwargs):
        ...
        resource_path = '/v2/diagnostics/request_logs/{requestLogId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_resources_with_http_info(self, **kwargs):
        ...
        resource_path = '/v2'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_service(self, **kwargs):
        ...
        Retrieves the available REST API versions.  DocuSign Production system: https://www.docusign_esign.net/restapi/service_information DocuSign Demo system: https://demo.docusign.net/restapi/service_information  You do not need an integrator key to view the REST API versions and resources.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
