...
class UsersApi(object):
    ...
    def get_user_list_export(self, organization_id, result_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_user_list_export(organization_id, result_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_user_list_export_with_http_info(organization_id, result_id, **kwargs)
        else:
            (data) = self.get_user_list_export_with_http_info(organization_id, result_id, **kwargs)
            return data

    def get_user_list_export_with_http_info(self, organization_id, result_id, **kwargs):
        """
        Retrieves UserList Export Results data.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_user_list_export_with_http_info(organization_id, result_id, callback=callback_function)
        ...
        if ('result_id' not in params) or (params['result_id'] is None):
            raise ValueError("Missing the required parameter `result_id` when calling `get_user_list_export`")


        collection_formats = {}

        resource_path = '/v2.1/organization_exports/{organizationId}/user_list/{resultId}'.replace('{format}', 'json')
        path_params = {}
