...
class FoldersApi(object):
    ...
    def list_with_http_info(self, account_id, **kwargs):
        ...
        all_params = ['account_id', 'include', 'start_position', 'template', 'user_filter']
        ...
        resource_path = '/v2/accounts/{accountId}/folders'.replace('{format}', 'json')
        path_params = {}
    ...
    def list_items_with_http_info(self, account_id, folder_id, **kwargs):
        ...
        all_params = ['account_id', 'folder_id', 'from_date', 'owner_email', 'owner_name', 'search_text', 'start_position', 'status', 'to_date']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        resource_path = '/v2/accounts/{accountId}/folders/{folderId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
    ...
    def search_with_http_info(self, account_id, search_folder_id, **kwargs):
        ...
        resource_path = '/v2/accounts/{accountId}/search_folders/{searchFolderId}'.replace('{format}', 'json')
        path_params = {}
        if 'account_id' in params:
            path_params['accountId'] = params['account_id']
