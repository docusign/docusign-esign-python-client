...
class EnvelopeTransferRuleRequest(object):
    ...
    def __init__(self, carbon_copy_original_owner=None, enabled=None, envelope_transfer_rule_id=None, event_type=None, from_groups=None, from_users=None, modified_date=None, modified_user=None, to_folder=None, to_user=None):  # noqa: E501
