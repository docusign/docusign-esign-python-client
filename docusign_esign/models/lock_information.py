...
class LockInformation(object):
    ...
    """
    def __init__(self, error_details=None, lock_duration_in_seconds=None, locked_by_app=None, locked_by_user=None, locked_until_date_time=None, lock_token=None, lock_type=None, use_scratch_pad=None):
        """
    ...
    def error_details(self):
        """
        Gets the error_details of this LockInformation.

        :return: The error_details of this LockInformation.
        :rtype: ErrorDetails
        """
    ...
    def error_details(self, error_details):
        ...
        :param error_details: The error_details of this LockInformation.
        :type: ErrorDetails
        """
    ...
    def lock_duration_in_seconds(self):
        """
        Gets the lock_duration_in_seconds of this LockInformation.
        ...
        :return: The lock_duration_in_seconds of this LockInformation.
        :rtype: str
        """
    ...
    def lock_duration_in_seconds(self, lock_duration_in_seconds):
        ...
        :param lock_duration_in_seconds: The lock_duration_in_seconds of this LockInformation.
        :type: str
        """
    ...
    def locked_by_app(self):
        """
        Gets the locked_by_app of this LockInformation.
        Specifies the friendly name of  the application that is locking the envelope.

        :return: The locked_by_app of this LockInformation.
        :rtype: str
        """
    ...
    def locked_by_app(self, locked_by_app):
        ...
        :param locked_by_app: The locked_by_app of this LockInformation.
        :type: str
        """
    ...
    def locked_by_user(self):
        """
        Gets the locked_by_user of this LockInformation.

        :return: The locked_by_user of this LockInformation.
        :rtype: UserInfo
        """
    ...
    def locked_by_user(self, locked_by_user):
        ...
        :param locked_by_user: The locked_by_user of this LockInformation.
        :type: UserInfo
        """
    ...
    def locked_until_date_time(self):
        """
        Gets the locked_until_date_time of this LockInformation.
        The datetime until the envelope lock expires.

        :return: The locked_until_date_time of this LockInformation.
        :rtype: str
        """
    ...
    def locked_until_date_time(self, locked_until_date_time):
        ...
        :param locked_until_date_time: The locked_until_date_time of this LockInformation.
        :type: str
        """
    ...
    def lock_token(self, lock_token):
        ...
        :param lock_token: The lock_token of this LockInformation.
        :type: str
        """
    ...
    def lock_type(self):
        """
        Gets the lock_type of this LockInformation.
        The type of envelope lock.  Currently \"edit\" is the only supported type.

        :return: The lock_type of this LockInformation.
        :rtype: str
        """
    ...
    def lock_type(self, lock_type):
        ...
        :param lock_type: The lock_type of this LockInformation.
        :type: str
        """
    ...
    def use_scratch_pad(self):
        """
        Gets the use_scratch_pad of this LockInformation.
        Reserved for future use.  Indicates whether a scratchpad is used for editing information.  

        :return: The use_scratch_pad of this LockInformation.
        :rtype: str
        """
    ...
    def use_scratch_pad(self, use_scratch_pad):
        ...
        :param use_scratch_pad: The use_scratch_pad of this LockInformation.
        :type: str
        """
