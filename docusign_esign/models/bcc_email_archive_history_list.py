...
class BccEmailArchiveHistoryList(object):
    ...
    def __init__(self, bcc_email_archive_history=None, end_position=None, next_uri=None, previous_uri=None, result_set_size=None, start_position=None, total_set_size=None):  # noqa: E501
        ...
        if bcc_email_archive_history is not None:
            self.bcc_email_archive_history = bcc_email_archive_history
