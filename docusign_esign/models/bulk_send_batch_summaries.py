...
class BulkSendBatchSummaries(object):
    ...
    def __init__(self, batch_size_limit=None, bulk_batch_summaries=None, end_position=None, next_uri=None, previous_uri=None, queue_limit=None, result_set_size=None, start_position=None, total_queued=None, total_set_size=None):  # noqa: E501
        ...
        if bulk_batch_summaries is not None:
            self.bulk_batch_summaries = bulk_batch_summaries
