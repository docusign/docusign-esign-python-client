...
class WorkspaceUser(object):
    ...
    def __init__(self, account_id=None, account_name=None, active_since=None, created=None, created_by_id=None, email=None, error_details=None, invitation_email_blurb=None, invitation_email_subject=None, last_modified=None, last_modified_by_id=None, status=None, type=None, user_id=None, user_name=None, workspace_id=None, workspace_user_base_url=None, workspace_user_id=None, workspace_user_uri=None):  # noqa: E501
        ...
        if invitation_email_blurb is not None:
            self.invitation_email_blurb = invitation_email_blurb
        if invitation_email_subject is not None:
            self.invitation_email_subject = invitation_email_subject
        ...
        if workspace_user_base_url is not None:
            self.workspace_user_base_url = workspace_user_base_url
        if workspace_user_id is not None:
            self.workspace_user_id = workspace_user_id
        if workspace_user_uri is not None:
            self.workspace_user_uri = workspace_user_uri
