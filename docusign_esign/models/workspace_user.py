...
class WorkspaceUser(object):
    ...
    def __init__(self, account_id=None, account_name=None, active_since=None, created=None, created_by_id=None, email=None, error_details=None, last_modified=None, last_modified_by_id=None, status=None, type=None, user_id=None, user_name=None, workspace_id=None, workspace_user_base_url=None, workspace_user_id=None):  # noqa: E501
