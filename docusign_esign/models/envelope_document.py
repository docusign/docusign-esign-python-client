...
class EnvelopeDocument(object):
    ...
    """
    def __init__(self, attachment_tab_id=None, available_document_types=None, contains_pdf_form_fields=None, display=None, document_fields=None, document_group=None, document_id=None, error_details=None, include_in_download=None, name=None, order=None, pages=None, signer_must_acknowledge=None, type=None, uri=None):
        """
