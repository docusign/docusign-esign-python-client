...
class PowerFormSendersResponse(object):
    ...
    def __init__(self, end_position=None, next_uri=None, power_form_senders=None, previous_uri=None, result_set_size=None, start_position=None, total_set_size=None):  # noqa: E501
        ...
        if power_form_senders is not None:
            self.power_form_senders = power_form_senders
