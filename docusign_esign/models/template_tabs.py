...
class TemplateTabs(object):
    ...
    """
    def __init__(self, approve_tabs=None, checkbox_tabs=None, company_tabs=None, date_signed_tabs=None, date_tabs=None, decline_tabs=None, email_address_tabs=None, email_tabs=None, envelope_id_tabs=None, first_name_tabs=None, formula_tabs=None, full_name_tabs=None, initial_here_tabs=None, last_name_tabs=None, list_tabs=None, note_tabs=None, number_tabs=None, radio_group_tabs=None, signer_attachment_tabs=None, sign_here_tabs=None, ssn_tabs=None, text_tabs=None, title_tabs=None, view_tabs=None, zip_tabs=None):
        """
