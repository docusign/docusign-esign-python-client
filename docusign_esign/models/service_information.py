...
class ServiceInformation(object):
    ...
    def __init__(self, build_branch=None, build_branch_deployed_date_time=None, build_sha=None, build_version=None, linked_sites=None, service_versions=None):  # noqa: E501
        ...
        if build_branch_deployed_date_time is not None:
            self.build_branch_deployed_date_time = build_branch_deployed_date_time
        if build_sha is not None:
            self.build_sha = build_sha
        if build_version is not None:
            self.build_version = build_version
        if linked_sites is not None:
            self.linked_sites = linked_sites
