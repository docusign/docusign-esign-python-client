...
class UserInfo(object):
    ...
    def __init__(self, activation_access_code=None, email=None, error_details=None, login_status=None, send_activation_email=None, uri=None, user_id=None, user_name=None, user_status=None, user_type=None):  # noqa: E501
