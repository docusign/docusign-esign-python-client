...
class RadioGroup(object):
    ...
    def __init__(self, conditional_parent_label=None, conditional_parent_value=None, document_id=None, group_name=None, radios=None, recipient_id=None, require_all=None, require_initial_on_shared_change=None, shared=None, template_locked=None, template_required=None, tooltip=None):  # noqa: E501
