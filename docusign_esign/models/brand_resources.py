...
class BrandResources(object):
    ...
    def __init__(self, created_by_user_info=None, created_date=None, modified_by_user_info=None, modified_date=None, modified_templates=None, resources_content_type=None, resources_content_uri=None):  # noqa: E501
