...
class NotaryHost(object):
    ...
    def __init__(self, access_code=None, add_access_code_to_email=None, client_user_id=None, custom_fields=None, declined_date_time=None, declined_reason=None, delivered_date_time=None, delivery_method=None, document_visibility=None, email=None, email_notification=None, embedded_recipient_start_url=None, error_details=None, fax_number=None, host_recipient_id=None, id_check_configuration_name=None, id_check_information_input=None, inherit_email_notification_configuration=None, name=None, notary_email_metadata=None, notary_name_metadata=None, note=None, phone_authentication=None, recipient_attachments=None, recipient_authentication_status=None, recipient_id=None, recipient_id_guid=None, require_id_lookup=None, role_name=None, routing_order=None, saml_authentication=None, sent_date_time=None, signed_date_time=None, sms_authentication=None, social_authentications=None, status=None, template_locked=None, template_required=None, total_tab_count=None, user_id=None):
        ...
        self._name = name
        self._notary_email_metadata = notary_email_metadata
        self._notary_name_metadata = notary_name_metadata
        self._note = note
    ...
    @property
    def notary_email_metadata(self):
        """
        Gets the notary_email_metadata of this NotaryHost.

        :return: The notary_email_metadata of this NotaryHost.
        :rtype: PropertyMetadata
        """
        return self._notary_email_metadata

    @notary_email_metadata.setter
    def notary_email_metadata(self, notary_email_metadata):
        """
        Sets the notary_email_metadata of this NotaryHost.

        :param notary_email_metadata: The notary_email_metadata of this NotaryHost.
    ...
    @property
    def notary_name_metadata(self):
        """
        Gets the notary_name_metadata of this NotaryHost.

        :return: The notary_name_metadata of this NotaryHost.
        :rtype: PropertyMetadata
        """
        return self._notary_name_metadata

    @notary_name_metadata.setter
    def notary_name_metadata(self, notary_name_metadata):
        """
        Sets the notary_name_metadata of this NotaryHost.

        :param notary_name_metadata: The notary_name_metadata of this NotaryHost.
        :type: PropertyMetadata
        """
    ...
    def saml_authentication(self):
        """
        Gets the saml_authentication of this NotaryHost.

        :return: The saml_authentication of this NotaryHost.
    ...
    def saml_authentication(self, saml_authentication):
        """
        Sets the saml_authentication of this NotaryHost.

        :param saml_authentication: The saml_authentication of this NotaryHost.
