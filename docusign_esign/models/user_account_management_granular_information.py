...
class UserAccountManagementGranularInformation(object):
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        setattr(self, "_{}".format('can_manage_groups'), kwargs.get('can_manage_groups', None))
        setattr(self, "_{}".format('can_manage_groups_metadata'), kwargs.get('can_manage_groups_metadata', None))
        ...
        setattr(self, "_{}".format('can_view_users_metadata'), kwargs.get('can_view_users_metadata', None))
