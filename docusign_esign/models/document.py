...
class Document(object):
    ...
    """
    def __init__(self, apply_anchor_tabs=None, display=None, document_base64=None, document_fields=None, document_group=None, document_id=None, encrypted_with_key_manager=None, file_extension=None, file_format_hint=None, html_definition=None, include_in_download=None, is_dynamic_xfa=None, is_static_xfa=None, match_boxes=None, name=None, ocr_requests=None, order=None, page_count=None, pages=None, page_sizes=None, password=None, pdf_fields_data=None, pdf_form_field_option=None, pdf_widgets_base64=None, remote_url=None, signer_must_acknowledge=None, tabs=None, template_locked=None, template_required=None, transform_pdf_fields=None, uri=None):
        """
