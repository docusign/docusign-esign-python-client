...
class Document(object):
    ...
    """
    def __init__(self, apply_anchor_tabs=None, display=None, document_base64=None, document_fields=None, document_group=None, document_id=None, encrypted_with_key_manager=None, file_extension=None, file_format_hint=None, include_in_download=None, match_boxes=None, name=None, order=None, pages=None, password=None, remote_url=None, signer_must_acknowledge=None, template_locked=None, template_required=None, transform_pdf_fields=None, uri=None):
        """
