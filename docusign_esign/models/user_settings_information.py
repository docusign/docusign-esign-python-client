...
class UserSettingsInformation(object):
    ...
    def __init__(self, account_management_granular=None, admin_only=None, admin_only_metadata=None, allow_auto_tagging=None, allow_envelope_transfer_to=None, allow_envelope_transfer_to_metadata=None, allow_eseal_recipients=None, allow_eseal_recipients_metadata=None, allow_power_forms_admin_to_access_all_power_form_envelope=None, allow_power_forms_admin_to_access_all_power_form_envelope_metadata=None, allow_recipient_language_selection=None, allow_recipient_language_selection_metadata=None, allow_send_on_behalf_of=None, allow_send_on_behalf_of_metadata=None, allow_supplemental_documents=None, allow_supplemental_documents_metadata=None, anchor_tag_versioned_placement_enabled=None, api_account_wide_access=None, api_account_wide_access_metadata=None, api_can_export_ac=None, api_can_export_ac_metadata=None, bulk_send=None, bulk_send_metadata=None, can_charge_account=None, can_charge_account_metadata=None, can_edit_shared_addressbook=None, can_edit_shared_addressbook_metadata=None, can_lock_envelopes=None, can_lock_envelopes_metadata=None, can_manage_account=None, can_manage_account_metadata=None, can_manage_distributor=None, can_manage_distributor_metadata=None, can_manage_templates=None, can_manage_templates_metadata=None, can_send_api_requests=None, can_send_api_requests_metadata=None, can_send_envelope=None, can_send_envelope_metadata=None, can_send_envelopes_via_sms=None, can_send_envelopes_via_sms_metadata=None, can_sign_envelope=None, can_sign_envelope_metadata=None, can_use_scratchpad=None, can_use_scratchpad_metadata=None, can_use_smart_contracts=None, can_use_smart_contracts_metadata=None, disable_document_upload=None, disable_document_upload_metadata=None, disable_other_actions=None, disable_other_actions_metadata=None, enable_ds_pro=None, enable_ds_pro_metadata=None, enable_sequential_signing_api=None, enable_sequential_signing_api_metadata=None, enable_sequential_signing_ui=None, enable_sequential_signing_ui_metadata=None, enable_signer_attachments=None, enable_signer_attachments_metadata=None, enable_sign_on_paper_override=None, enable_sign_on_paper_override_metadata=None, enable_transaction_point=None, enable_transaction_point_metadata=None, enable_vaulting=None, enable_vaulting_metadata=None, express_send_only=None, locale=None, locale_metadata=None, locale_policy=None, manage_clickwraps_mode=None, manage_clickwraps_mode_metadata=None, modified_by=None, modified_by_metadata=None, modified_date=None, modified_date_metadata=None, modified_page=None, modified_page_metadata=None, new_send_ui=None, new_send_ui_metadata=None, power_form_mode=None, power_form_mode_metadata=None, recipient_viewed_notification=None, recipient_viewed_notification_metadata=None, seal_identifiers=None, self_signed_recipient_email_document=None, self_signed_recipient_email_document_metadata=None, sender_email_notifications=None, signer_email_notifications=None, supplemental_document_include_in_download=None, supplemental_documents_must_accept=None, supplemental_documents_must_accept_metadata=None, supplemental_documents_must_read=None, supplemental_documents_must_read_metadata=None, supplemental_documents_must_view=None, supplemental_documents_must_view_metadata=None, template_active_creation=None, template_active_creation_metadata=None, template_apply_notify=None, template_apply_notify_metadata=None, template_auto_matching=None, template_auto_matching_metadata=None, template_matching_sensitivity=None, template_matching_sensitivity_metadata=None, template_page_level_matching=None, template_page_level_matching_metadata=None, timezone_dst=None, timezone_dst_metadata=None, timezone_mask=None, timezone_mask_metadata=None, timezone_offset=None, timezone_offset_metadata=None, timezone_sending_pref=None, timezone_sending_pref_metadata=None, timezone_signing_pref=None, timezone_signing_pref_metadata=None, transaction_point_site_name_url=None, transaction_point_site_name_url_metadata=None, transaction_point_user_name=None, transaction_point_user_name_metadata=None, vaulting_mode=None, vaulting_mode_metadata=None):  # noqa: E501
        ...
        if admin_only_metadata is not None:
            self.admin_only_metadata = admin_only_metadata
        if allow_auto_tagging is not None:
            self.allow_auto_tagging = allow_auto_tagging
        if allow_envelope_transfer_to is not None:
            self.allow_envelope_transfer_to = allow_envelope_transfer_to
        if allow_envelope_transfer_to_metadata is not None:
            self.allow_envelope_transfer_to_metadata = allow_envelope_transfer_to_metadata
        if allow_eseal_recipients is not None:
            self.allow_eseal_recipients = allow_eseal_recipients
        if allow_eseal_recipients_metadata is not None:
            self.allow_eseal_recipients_metadata = allow_eseal_recipients_metadata
        if allow_power_forms_admin_to_access_all_power_form_envelope is not None:
            self.allow_power_forms_admin_to_access_all_power_form_envelope = allow_power_forms_admin_to_access_all_power_form_envelope
        if allow_power_forms_admin_to_access_all_power_form_envelope_metadata is not None:
            self.allow_power_forms_admin_to_access_all_power_form_envelope_metadata = allow_power_forms_admin_to_access_all_power_form_envelope_metadata
        if allow_recipient_language_selection is not None:
            self.allow_recipient_language_selection = allow_recipient_language_selection
        if allow_recipient_language_selection_metadata is not None:
            self.allow_recipient_language_selection_metadata = allow_recipient_language_selection_metadata
        if allow_send_on_behalf_of is not None:
            self.allow_send_on_behalf_of = allow_send_on_behalf_of
        if allow_send_on_behalf_of_metadata is not None:
            self.allow_send_on_behalf_of_metadata = allow_send_on_behalf_of_metadata
        ...
        if api_account_wide_access is not None:
            self.api_account_wide_access = api_account_wide_access
        if api_account_wide_access_metadata is not None:
            self.api_account_wide_access_metadata = api_account_wide_access_metadata
        if api_can_export_ac is not None:
            self.api_can_export_ac = api_can_export_ac
        if api_can_export_ac_metadata is not None:
            self.api_can_export_ac_metadata = api_can_export_ac_metadata
        ...
        if can_charge_account is not None:
            self.can_charge_account = can_charge_account
        if can_charge_account_metadata is not None:
            self.can_charge_account_metadata = can_charge_account_metadata
        if can_edit_shared_addressbook is not None:
            self.can_edit_shared_addressbook = can_edit_shared_addressbook
        if can_edit_shared_addressbook_metadata is not None:
            self.can_edit_shared_addressbook_metadata = can_edit_shared_addressbook_metadata
        if can_lock_envelopes is not None:
            self.can_lock_envelopes = can_lock_envelopes
        if can_lock_envelopes_metadata is not None:
            self.can_lock_envelopes_metadata = can_lock_envelopes_metadata
        if can_manage_account is not None:
            self.can_manage_account = can_manage_account
        if can_manage_account_metadata is not None:
            self.can_manage_account_metadata = can_manage_account_metadata
        if can_manage_distributor is not None:
            self.can_manage_distributor = can_manage_distributor
        if can_manage_distributor_metadata is not None:
            self.can_manage_distributor_metadata = can_manage_distributor_metadata
        if can_manage_templates is not None:
            self.can_manage_templates = can_manage_templates
        if can_manage_templates_metadata is not None:
            self.can_manage_templates_metadata = can_manage_templates_metadata
        if can_send_api_requests is not None:
            self.can_send_api_requests = can_send_api_requests
        if can_send_api_requests_metadata is not None:
            self.can_send_api_requests_metadata = can_send_api_requests_metadata
        if can_send_envelope is not None:
        ...
        if can_sign_envelope_metadata is not None:
            self.can_sign_envelope_metadata = can_sign_envelope_metadata
        if can_use_scratchpad is not None:
            self.can_use_scratchpad = can_use_scratchpad
        if can_use_scratchpad_metadata is not None:
            self.can_use_scratchpad_metadata = can_use_scratchpad_metadata
        if can_use_smart_contracts is not None:
            self.can_use_smart_contracts = can_use_smart_contracts
        if can_use_smart_contracts_metadata is not None:
            self.can_use_smart_contracts_metadata = can_use_smart_contracts_metadata
        ...
        if express_send_only is not None:
            self.express_send_only = express_send_only
        if locale is not None:
            self.locale = locale
        if locale_metadata is not None:
            self.locale_metadata = locale_metadata
        if locale_policy is not None:
            self.locale_policy = locale_policy
        if manage_clickwraps_mode is not None:
            self.manage_clickwraps_mode = manage_clickwraps_mode
        if manage_clickwraps_mode_metadata is not None:
            self.manage_clickwraps_mode_metadata = manage_clickwraps_mode_metadata
        if modified_by is not None:
            self.modified_by = modified_by
        if modified_by_metadata is not None:
            self.modified_by_metadata = modified_by_metadata
        if modified_date is not None:
            self.modified_date = modified_date
        if modified_date_metadata is not None:
            self.modified_date_metadata = modified_date_metadata
        if modified_page is not None:
            self.modified_page = modified_page
        if modified_page_metadata is not None:
            self.modified_page_metadata = modified_page_metadata
        if new_send_ui is not None:
            self.new_send_ui = new_send_ui
        if new_send_ui_metadata is not None:
            self.new_send_ui_metadata = new_send_ui_metadata
        if power_form_mode is not None:
            self.power_form_mode = power_form_mode
        if power_form_mode_metadata is not None:
            self.power_form_mode_metadata = power_form_mode_metadata
        if recipient_viewed_notification is not None:
            self.recipient_viewed_notification = recipient_viewed_notification
        if recipient_viewed_notification_metadata is not None:
            self.recipient_viewed_notification_metadata = recipient_viewed_notification_metadata
        if seal_identifiers is not None:
            self.seal_identifiers = seal_identifiers
        ...
        if supplemental_document_include_in_download is not None:
            self.supplemental_document_include_in_download = supplemental_document_include_in_download
        ...
        if template_active_creation is not None:
            self.template_active_creation = template_active_creation
        if template_active_creation_metadata is not None:
            self.template_active_creation_metadata = template_active_creation_metadata
        if template_apply_notify is not None:
            self.template_apply_notify = template_apply_notify
        if template_apply_notify_metadata is not None:
            self.template_apply_notify_metadata = template_apply_notify_metadata
        if template_auto_matching is not None:
            self.template_auto_matching = template_auto_matching
        if template_auto_matching_metadata is not None:
            self.template_auto_matching_metadata = template_auto_matching_metadata
        if template_matching_sensitivity is not None:
            self.template_matching_sensitivity = template_matching_sensitivity
        if template_matching_sensitivity_metadata is not None:
            self.template_matching_sensitivity_metadata = template_matching_sensitivity_metadata
        if template_page_level_matching is not None:
            self.template_page_level_matching = template_page_level_matching
        if template_page_level_matching_metadata is not None:
            self.template_page_level_matching_metadata = template_page_level_matching_metadata
        if timezone_dst is not None:
            self.timezone_dst = timezone_dst
        if timezone_dst_metadata is not None:
            self.timezone_dst_metadata = timezone_dst_metadata
        if timezone_mask is not None:
            self.timezone_mask = timezone_mask
        if timezone_mask_metadata is not None:
            self.timezone_mask_metadata = timezone_mask_metadata
        if timezone_offset is not None:
            self.timezone_offset = timezone_offset
        if timezone_offset_metadata is not None:
            self.timezone_offset_metadata = timezone_offset_metadata
        if timezone_sending_pref is not None:
            self.timezone_sending_pref = timezone_sending_pref
        if timezone_sending_pref_metadata is not None:
            self.timezone_sending_pref_metadata = timezone_sending_pref_metadata
        if timezone_signing_pref is not None:
            self.timezone_signing_pref = timezone_signing_pref
        if timezone_signing_pref_metadata is not None:
            self.timezone_signing_pref_metadata = timezone_signing_pref_metadata
        if transaction_point_site_name_url is not None:
            self.transaction_point_site_name_url = transaction_point_site_name_url
        if transaction_point_site_name_url_metadata is not None:
            self.transaction_point_site_name_url_metadata = transaction_point_site_name_url_metadata
        if transaction_point_user_name is not None:
            self.transaction_point_user_name = transaction_point_user_name
        if transaction_point_user_name_metadata is not None:
            self.transaction_point_user_name_metadata = transaction_point_user_name_metadata
