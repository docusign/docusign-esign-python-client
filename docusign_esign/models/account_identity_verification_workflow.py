...
class AccountIdentityVerificationWorkflow(object):
    ...
    def __init__(self, default_description=None, default_name=None, input_options=None, signature_provider=None, steps=None, workflow_id=None, workflow_resource_key=None):  # noqa: E501
        ...
        if workflow_resource_key is not None:
            self.workflow_resource_key = workflow_resource_key
