...
class RecipientSignatureProvider(object):
    ...
    def __init__(self, seal_documents_with_tabs_only=None, seal_name=None, signature_provider_name=None, signature_provider_name_metadata=None, signature_provider_options=None):  # noqa: E501
        ...
        if signature_provider_name_metadata is not None:
            self.signature_provider_name_metadata = signature_provider_name_metadata
