...
class TemplateSummary(object):
    ...
    def __init__(self, applied=None, document_id=None, document_name=None, error_details=None, name=None, template_id=None, template_match=None, uri=None):  # noqa: E501
