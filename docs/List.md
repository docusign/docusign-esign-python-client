...
**list_items** | [**list[ListItem]**](ListItem.md) | The list of values that can be selected by senders. The list values are separated by semi-colons. Example: [one;two;three;four]  Maximum Length of listItems:  2048 characters. Maximum Length of items in the list: 100 characters.   | [optional] 
...
**value** | **str** | The value to use when the item is selected. | [optional] 
