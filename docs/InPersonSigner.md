...
**can_sign_offline** | **str** | When set to **true**, specifies that the signer can perform the signing ceremony offline. | [optional] 
...
**default_recipient** | **str** |  | [optional] 
...
**host_name** | **str** | Specifies the name of the signing host. It is a required element for In Person Signers recipient Type.  Maximum Length: 100 characters. | [optional] 
...
**in_person_signing_type** | **str** |  | [optional] 
**name** | **str** |  | [optional] 
...
**require_signer_certificate** | **str** |  | [optional] 
**require_sign_on_paper** | **str** |  | [optional] 
...
**signer_email** | **str** | The email address for an InPersonSigner recipient Type.   Maximum Length: 100 characters.  | [optional] 
**signer_name** | **str** | Required. The full legal name of a signer for the envelope.   Maximum Length: 100 characters.    | [optional] 
